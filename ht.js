...
function displayHeartGroup() {
    ...
    const messages = ["sekarang kita udah jadian ❤️", "tgl jadian kita: " + currentDateTime, "Panggil Kamu Apa Nih?"];
        ...
        heartIcon.onclick = function() {
            setTimeout(() => {
                if (this.id === "heart-icon-special") {
                    showMessage("kita gak jodoh ya 💔, aku gak bakalan ganggu kamu lagi", false);
                } else {
